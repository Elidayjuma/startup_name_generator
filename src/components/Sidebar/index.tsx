...
const menuGroups = [
  {
    ...
    menuItems: [
...

      {
        ...
        route: "#",
        children: [
          { label: "My Prompts", route: "/prompts" },
          { label: "Add Prompts", route: "/prompts/add" },
        ],
      },
      {
        icon: (
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Profile Setting", route: "/settings" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Get WP password", route: "https://elidayjuma.com/unlocking-the-wordpress-api-a-step-by-step-guide-to-secure-your-password-and-boost-your-site/" },
